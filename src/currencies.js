const XRPValidator = require('./validators/ripple_validator')
const ETHValidator = require('./validators/ethereum_validator')
const BTCValidator = require('./validators/bitcoin_validator')
const ADAValidator = require('./validators/cardano_validator')
const XMRValidator = require('./validators/monero_validator')
const NANOValidator = require('./validators/nano_validator')
const LSKValidator = require('./validators/lisk_validator')
...
const IOSTValidator = require('./validators/iost_validator')
